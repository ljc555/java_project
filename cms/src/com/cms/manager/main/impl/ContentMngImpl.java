...
import static com.cms.entity.main.ContentCheck.DRAFT;
...
import com.cms.dao.main.ContentDao;
import com.cms.entity.assist.CmsFile;
import com.cms.entity.main.Channel;
import com.cms.entity.main.CmsGroup;
import com.cms.entity.main.CmsSite;
import com.cms.entity.main.CmsTopic;
import com.cms.entity.main.CmsUser;
import com.cms.entity.main.CmsUserSite;
import com.cms.entity.main.Content;
import com.cms.entity.main.ContentCheck;
import com.cms.entity.main.ContentCount;
import com.cms.entity.main.ContentExt;
import com.cms.entity.main.ContentTag;
import com.cms.entity.main.ContentTxt;
import com.cms.entity.main.Channel.AfterCheckEnum;
import com.cms.entity.main.Content.ContentStatus;
import com.cms.manager.assist.CmsCommentMng;
import com.cms.manager.assist.CmsFileMng;
import com.cms.manager.main.ChannelMng;
import com.cms.manager.main.CmsGroupMng;
import com.cms.manager.main.CmsTopicMng;
import com.cms.manager.main.CmsUserMng;
import com.cms.manager.main.ContentCheckMng;
import com.cms.manager.main.ContentCountMng;
import com.cms.manager.main.ContentExtMng;
import com.cms.manager.main.ContentMng;
import com.cms.manager.main.ContentTagMng;
import com.cms.manager.main.ContentTxtMng;
import com.cms.manager.main.ContentTypeMng;
import com.cms.service.ChannelDeleteChecker;
import com.cms.service.ContentListener;
import com.cms.staticpage.StaticPageSvc;
import com.cms.staticpage.exception.ContentNotCheckedException;
import com.cms.staticpage.exception.GeneratedZeroStaticPageException;
import com.cms.staticpage.exception.StaticPageNotOpenException;
import com.cms.staticpage.exception.TemplateNotFoundException;
import com.cms.staticpage.exception.TemplateParseException;
...
public class ContentMngImpl implements ContentMng, ChannelDeleteChecker {
	...
	public Content deleteById(Integer id) {
		...
		//删除附件start20151218
		Set<CmsFile> file = bean.getFiles();
		Iterator<CmsFile> iterator = file.iterator();
		while(iterator.hasNext()){
			CmsFile cf=iterator.next();
			fileMng.deleteByPath(cf.getFilePath());
		}
